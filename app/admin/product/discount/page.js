...
export default function ProductDiscount() {
    ...
    useEffect(() => {
        ...
        const getData = async () => {
            ...
            try {
                const response = await axios.get(`${url}/product/discount/get`, {headers: headers})
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    ...
                    const response = await axios.post(`${url}/product/discount/delete/${uuid}`,{
            ...
            <div className="card">
                <div className="card-body">
                    <div className="d-flex justify-content-between align-items-center">
                        <h5>Product For Discount</h5>
                        <button className="btn btn-primary m-r-5" onClick={() => router.push('/admin/product/discount/add')}>Add Product</button>
                    </div>
                    <hr />
                    <div className="mt-10">
