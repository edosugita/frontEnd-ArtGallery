...
export default function AddProductDiscount() {
    ...
    const [isErrorDiscount, setIsErrorDiscount] = useState('')
    ...
    const handleAdd = async (event) => {
        ...
        try {
            const response = await axios.post(`${url}/product/discount/create`,{
                uuid,
                artname,
                artist,
                description,
            ...
            if (responseData.status == 201) {
                Swal.fire({
                    ...
                    willClose: () => {
                        router.push('/admin/product/discount')
                    }
                })
            }
            ...
            setIsErrorPrice(error.response?.data?.errors?.price || null)
            setIsErrorDiscount(error.response?.data?.errors?.discount || null)
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-12 col-sm-12">
                                    <div className="form-group">
                                        ...
                                        <input type="text" className={`form-control ${isErrorDiscount === '' ? '' : isErrorDiscount !== null ? 'is-invalid' : 'is-valid'}`} onChange={(e) => setDiscount(e.target.value)} placeholder="ex 10 tanpa %" />
                                        {isErrorDiscount !== null && (
                                        <div className="invalid-feedback">
                                            {isErrorDiscount}
                                        </div>
                                    )}
