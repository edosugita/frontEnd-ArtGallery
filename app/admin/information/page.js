...
export default function Product() {
    ...
    useEffect(() => {
        ...
        const getData = async () => {
            ...
            try {
                const response = await axios.get(`${url}/information/get`, {headers: headers})
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    ...
                    const id = data.id
                    const response = await axios.post(`${url}/information/delete/${id}`,{
            ...
            <div className="card">
                <div className="card-body">
                    <div className="d-flex justify-content-between align-items-center">
                        ...
                        <button className="btn btn-primary m-r-5" onClick={() => router.push('/admin/information/add')}>Add Information</button>
                    </div>
                    <hr />
                    <div className="mt-10">
